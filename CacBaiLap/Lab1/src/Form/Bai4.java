...
public class Bai4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nhập vào số điện:");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txts, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jLabel3.setText("Số tiền điện phải trả:");

        txtt.setFocusable(false);
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        // TODO add your handling code here:
        double so = Double.parseDouble(txts.getText());
        if(so<0)
            txtt.setText("Số điện không thể âm!");
        else
        {
            if(so<=50)
                txtt.setText(""+5000*so+" VND");
            else
                txtt.setText(""+(50*5000+(so-50)*6200)+" VND");
        }
